              ...
              <div>
                ...
                <div class="mt-2.5">
                  <input
                    ...
                    name=""
                    readonly
                    v-model="dform.DiscoID"
                    id=""
                    placeholder="Disco Id"
                    class="block w-full px-4 py-4 text-gray-900 placeholder-gray-600 bg-white border border-gray-400 rounded-mdfocus:border-gray-900 focus:ring-gray-900 caret-gray-900"
                  />
                </div>
              </div>
    ...
    async GetNetworks() {
      try {
        ...
        const res = await axios.get(
          `/api/admin/services?id=${userCred.uid}&service=ELECTRICITY`,
          {
            headers: {
    ...
    async SaveChanges() {
      try {
        ...
        const res = await axios.post(
          `/api/admin/services?id=${userCred.uid}&services=ELECTRICITY`,
          this.dform,
          {
            headers: {
              Accept: "application/json",
